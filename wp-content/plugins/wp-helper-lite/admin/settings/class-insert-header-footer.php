...
class WP_HELPER_Insert_Header_Footer extends WP_HELPER_Admin {
	...
	public function __construct( $WP_HELPER ) {
		...
		$this->label = __( 'Insert Header & Footer', 'mbwph' );
	...
	public function display_options_section( $params ) {
		_e('<h4>Insert Header & Footer</h4>','mbwph');
		_e('<span class="description">Chèn mã Google Analytics, Facebook...an toàn, không cần can thiệp vào code.</span>','mbwph');
	}
