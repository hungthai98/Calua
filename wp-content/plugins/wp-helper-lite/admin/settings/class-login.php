...
class WP_HELPER_Login extends WP_HELPER_Admin {
	...
	public function mbwph_login_post_init() {
		...
		add_settings_field(
			...
			array( $this, 'mbwph_cb_resize_logo_field' ),
			$this->WP_HELPER . '_mbwph_login_tab',
			$this->WP_HELPER . '-login-logo-options',
			array(
				'resize_logo'
	...
	public function display_options_section( $params ) {
		_e('<h3>ĐĂNG NHẬP</h3>','mbwph');
		_e('<span class="description">Cài đặt giao diện cho trang đăng nhập, xem hướng dẫn <a href="#" target="_blank">tại đây</a>.</span>','mbwph');
	}
	public function display_logo_options_section( $params ) {
		_e('<h4>Tùy chỉnh Logo</h4>','mbwph');
	}
	public function display_background_options_section( $params ) {
		_e('<h4>Tùy chỉnh nền</h4>','mbwph');
	}
	...
	public function mbwph_cb_enable_login_style_field() {				
		...
		<div class="pretty p-switch p-fill">
			<input type="checkbox" name="enable_login_style" value="1" <?php checked( $option, 1 , true ); ?> />
			<div class="state p-success">
				<label></label>
			</div>
		</div>
		<span class="description"><?php _e('Cho phép đổi giao diện đăng nhập.', 'mbwph'); ?></span>
...
<?php	}
	public function mbwph_cb_bg_repeat_field() {				
		...
		?>		
		<div class="pretty p-switch p-fill">
			<input type="checkbox" name="bg_repeat" value="1" <?php checked( $option, 1 , true ); ?> />
			<div class="state p-success">
				<label></label>
			</div>
		</div>
...
<?php
	...
	public function mbwph_cb_bg_scale_field() {				
		...
		?>		
		<div class="pretty p-switch p-fill">
			<input type="checkbox" name="bg_scale" value="1" <?php checked( $option, 1 , true ); ?> />
			<div class="state p-success">
				<label></label>
			</div>
		</div>
...
<?php	
	...
	public function mbwph_cb_resize_logo_field() {				
		$option 	= get_option('resize_logo');		
		?>		
		<div class="pretty p-switch p-fill">
			<input type="checkbox" name="resize_logo" value="1" <?php checked( $option, 1 , true ); ?> />
			<div class="state p-success">
				<label></label>
			</div>
		</div>
...
<?php
	...
	public function mbwph_txt_set_logo_size_field() {				
		...
		?>		
		<div class="form-group">			
			<input id="set_logo_size" name="set_logo_size" type="text" data-provide="slider" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="<?php echo( $option); ?>"/>
			<span><input id = "logoSizeVal" class="mbwphNumber" type="text" value = "<?php echo( $option); ?>" readonly /> %</span>			
		</div>
<?php
	}
	public function mbwph_txt_set_logo_height_field() {				
		...
		?>		
		<div class="form-group">			
			<input id="set_logo_height" name="set_logo_height" type="text" data-provide="slider" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="<?php echo( $option); ?>"/>
			<span><input id = "logoHeightVal" class="mbwphNumber" type="text" value = "<?php echo( $option); ?>" readonly /> %</span>			
		</div>
<?php
	}
...
<?php
	...
	public function mbwph_cb_set_transparent_form_field() {				
		...
		?>		
		<div class="pretty p-switch p-fill">
			<input type="checkbox" name="set_transparent_form" value="1" <?php checked( $option, 1 , true ); ?> />
			<div class="state p-success">
				<label></label>
			</div>
		</div>
		<span class="description"><?php _e('Chọn để hiển thị nền trong suốt.', 'mbwph'); ?></span>
<?php
	}
	public function mbwph_cb_set_transparent_input_field() {				
		...
		?>		
		<div class="pretty p-switch p-fill">
			<input type="checkbox" name="set_transparent_input" value="transparent" <?php checked( $option, 1 , true ); ?> />
			<div class="state p-success">
				<label></label>
			</div>
		</div>
