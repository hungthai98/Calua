	...
	class mbwph_Security_Load_Settings{
		...
		*/
		public function __construct() {
			...
			// $this->secret_key = $this->secureOptions["secret-key"];
			$this->setup_vars();
			$this->hooks();			
		}	
		function setup_vars(){
		...
		private function hooks(){			
			if(!empty($this->secureOptions["enable-captcha"]) && $this->secureOptions["enable-captcha"] == true){
			...
			if(!empty($this->secureOptions["enable-hide-login"]) && $this->secureOptions["enable-hide-login"] == true){
