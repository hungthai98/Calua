...
margin-top: <?php if(get_option('frm_login_top_margin') < 20) echo get_option('frm_login_top_margin') . "%"; else echo "7%"; ?>; padding: 18px 0 }
body.interim-login div#login {width: 95% !important; height: auto }
.login label, .login form, .login form p { color: <?php echo get_option('form_text_color'); ?> !important }
.login a { text-decoration: underline; color: <?php echo get_option('form_link_color'); ?> !important }
...
form#loginform .button-primary.focus,form#loginform .button-primary.hover,form#loginform .button-primary:focus,form#loginform .button-primary:hover, form#registerform .button-primary.focus, form#registerform .button-primary.hover,form#registerform .button-primary:focus,form#registerform .button-primary:hover { background: <?php echo get_option('form_button_hover_color'); ?> !important;
<?php if(!empty(get_option('pry_button_hover_border_color'))) echo "border-color:" . get_option('pry_button_hover_border_color') . "!important;"; ?> }
...
.login form input.input { background: <?php if(!empty(get_option('set_transparent_input'))) echo get_option('set_transparent_input'); else echo '#f1f1f1' ?> url(<?php echo WP_HELPER_PUBLIC_IMAGES_URL; ?>/login-sprite.png) no-repeat 12px -5px;padding: 9px 0 9px 38px !important; font-size: 16px !important; line-height: 1; outline: none !important;color: <?php if(!empty(get_option('input_text_color'))) echo get_option('input_text_color'); else echo '#e5e5e5' ?>;
border:1px solid <?php if(!empty(get_option('input_border_color'))) echo get_option('input_border_color'); else echo '#101010' ?>; box-shadow: 0 0 2px <?php if(!empty(get_option('input_border_color'))) echo get_option('input_border_color'); else echo '#222' ?>;
}
